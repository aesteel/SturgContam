...
#### as I reviewed the data, I fing more edits I hadn't made in ethovision, I'll  correct here. None apparent with WS yet (Dec 07, 2021)
```{r corrections}
#Tray D has very high movement rates when compared to the rest. In notes from video recordings, I said I set the box of glass bottles on the bottom of the recording shelf and shook the shelf at ~17 or 18 minutes. It could be that this shaking made the tracking lose the fish, and the tracks (and high distances moved) were not of the fish but rather jumping around with poor detection. I'll remove them for now, and should check on the videos again in the connon lab when I can get back in there. 
...
# I don't think this analysis went anywhere
...
DataSumAll = DataSumAll[DataSumAll$TrialTime>(2*60),] # the first 60 seconds already removed in tracking procedure
