...
WSdatasum2 <- WSdatasum1 %>%
  rename(InZone_C = InZone_Cent15, InZone_B = InZone_Cent25) %>%
  data.frame()

DataSum = rbind(WSdatasum2, GSdatasum1)
...
write.csv(DataSum, "outputData/Exposure_Outputdata/Bifenthrin_2022_23_Cleaned_NoConc.csv", row.names=F)
